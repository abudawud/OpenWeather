package com.envoss.openweather;
...
import com.envoss.openweather.adapter.WeatherAdapter;
import com.envoss.openweather.helper.MyAsyncTaskLoader;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<WeatherItems>>{
    public static String TAG = "X-LOG";
    ListView listView ;
